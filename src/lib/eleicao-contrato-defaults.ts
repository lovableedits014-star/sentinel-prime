// Textos padrão do contrato e do distrato da campanha (mesmo texto para os 3 cargos).
// A diferenciação por cargo é apenas visual (ver eleicao-contrato-docx.ts).

export const CONTRATO_TITULO_PADRAO = "Contrato de Prestação de Serviços na Campanha Eleitoral";
export const DISTRATO_TITULO_PADRAO = "Distrato de Prestação de Serviços de Cabo Eleitoral";

export const CONTRATO_PADRAO = `CONTRATO DE PRESTAÇÃO DE SERVIÇOS NA CAMPANHA ELEITORAL
