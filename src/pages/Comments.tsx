...
const Comments = () => {
  ...
  const handleSendResponse = useCallback(async (commentId: string, responseText: string, platform: string) => {
    ...
    try {
      ...
      if (data.success) {
        toast.success(`Resposta publicada no ${platform === 'instagram' ? 'Instagram as InstagramIcon' : 'Facebook as FacebookIcon'}!`);
      ...
      if (isRateLimit) {
        toast.error("Facebook as FacebookIcon bloqueou temporariamente seu acesso. Aguarde alguns minutos e tente novamente.", { duration: 8000 });
      } else {
        toast.error(msg);
      }
    } finally {
  ...
  const postGroups = useMemo((): PostGroup[] => {
    ...
    // Interleave Facebook as FacebookIcon and Instagram as InstagramIcon posts when platformFilter is "all"
  ...
  return (
    <div className="p-4 md:p-8 space-y-5 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Todos os comentários do Facebook as FacebookIcon e Instagram as InstagramIcon em um só lugar. Responda, oculte, gere respostas com IA e acompanhe o sentimento de cada interação. Posts aparecem em ordem cronológica com as duas plataformas intercaladas.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="bg-card rounded-xl border p-3 sm:p-4 flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
            <Facebook as FacebookIcon className="w-4 h-4 text-primary" />
          </div>
          <div>
        ...
        <div className="bg-card rounded-xl border p-3 sm:p-4 flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-secondary/50 flex items-center justify-center shrink-0">
            <Instagram as InstagramIcon className="w-4 h-4 text-secondary-foreground" />
          </div>
          <div>
          ...
          <div className="flex flex-1 flex-wrap gap-2">
            ...
            <Select value={platformFilter} onValueChange={setPlatformFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="facebook">Facebook as FacebookIcon</SelectItem>
                <SelectItem value="instagram">Instagram as InstagramIcon</SelectItem>
              </SelectContent>
            </Select>
