...
import {
  Briefcase, LogOut, CheckCircle2, Loader2, ExternalLink, Facebook as FacebookIcon,
...
export default function PortalContratado() {
  ...
  const getPlatformIcon = (p: string) => {
    if (p === "instagram") return <Instagram as InstagramIcon className="w-5 h-5 text-pink-500" />;
    if (p === "facebook") return <Facebook as FacebookIcon className="w-5 h-5 text-blue-600" />;
