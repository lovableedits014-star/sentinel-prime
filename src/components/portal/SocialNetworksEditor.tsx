...
const PLATFORM_OPTIONS = [
  { value: "instagram", label: "Instagram as InstagramIcon" },
  { value: "facebook", label: "Facebook as FacebookIcon" },
  { value: "tiktok", label: "TikTok" },
];

function PlatformIcon({ p }: { p: string }) {
  if (p === "instagram") return <Instagram as InstagramIcon className="w-4 h-4 text-pink-500" />;
  if (p === "facebook") return <Facebook as FacebookIcon className="w-4 h-4 text-blue-600" />;
