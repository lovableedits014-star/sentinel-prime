...
import { Loader2, FileText, Copy, Trash2, Sparkles, RefreshCw, History,   ExternalLink, MessageSquare, ThumbsUp, ThumbsDown, FileDown, Send, Star, Pencil, X, Check } from "lucide-react";
