...
const STATUS_META: Record<Status, { label: string; className: string; hint: string }> = {
  ...
  nao_rastreavel: {
    ...
    hint: "O Facebook as FacebookIcon só é rastreável quando vinculado a um comentário real (a Meta não expõe o @).",
  },
  sem_cadastro: {
    label: "Sem @",
    className: "bg-muted text-muted-foreground",
    hint: "Cadastre o Instagram as InstagramIcon e/ou vincule o Facebook as FacebookIcon para medir as interações.",
  },
};
    ...
    <div className="space-y-4">
      <Card>
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <CardDescription className="text-xs sm:text-sm">
                ...
                portal. O Instagram as InstagramIcon é rastreado pelo @; o Facebook as FacebookIcon só é rastreável quando vinculado a um
        ...
        <CardContent className="space-y-3 px-3 sm:px-6">
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Instagram as InstagramIcon</TableHead>
                    <TableHead>Facebook as FacebookIcon</TableHead>
                          ...
                          <TableCell>
                            {editing === key ? (
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                >
                                  <Instagram as InstagramIcon className="h-3.5 w-3.5" />@{r.instagram_handle}
                                </a>
                                <Button
                                  size="icon"
                                  variant="ghost"
                              ...
                              >
                                <Plus className="mr-1 h-3 w-3" />@ Instagram as InstagramIcon
                              </Button>
                            )}
                          </TableCell>
                          ...
                          <TableCell>
                            {r.facebook_key ? (
                              <div className="flex items-center gap-1">
                                ...
                                >
                                  <Facebook as FacebookIcon className="h-3 w-3" />
                                  {isMetaScopedId(r.facebook_key)
                              ...
                              >
                                ...
                                Vincular Facebook as FacebookIcon
                              </Button>
                            )}
                          </TableCell>
          ...
          <p className="text-xs text-muted-foreground">
            Curtidas do Facebook as FacebookIcon aparecem na coluna ♥ quando a coleta de reações está ativa. Curtidas do
            Instagram as InstagramIcon e compartilhamentos não são disponibilizados pela Meta por pessoa — use as Missões do
